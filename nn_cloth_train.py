...
class CNNBranch(nn.Module):
    ...
    def forward(self, h):
        ...
        #print(correl.device)#debug

        outx += delta0_*torch.ones_like(outx)/12 #normalization on channel
...
def train(model, pde, init_state, n_iters, learning_rate, dt, batch_size, save_path):
    ...
    #scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(optimizer, T_max=200, eta_min=1e-9, last_epoch=-1)
...
if __name__ == '__main__':
    ...
    #learning_rate = 1.003391277553334e-05
    learning_rate = 4.452100403665763e-06
    n_iters = 4000#2000
    batch_size =256#128
    save_path = './model/'
    #press = 3e6/2/2/4
