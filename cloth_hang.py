...
#pressure = 3000000/2/2/4 #0 #50000/2/2/4
pressure = 1e5/16
...
def initialize_mass_points():
    ...
    for i, j in x:
        x[i, j] = [
            i * quad_size - 0.5 + random_offset[0], 1.1,#0.6,
...
while window.running:
    ...
    #if gif_f == 233:
	#    window2.save_image('GIF_Hang_simu/high_hang_simu.png')
	#    print("done!")
    #window.save_image('GIF_Hang_simu/frame'+gif_fra+'.png')
    gif_f += 1 
    window.show()
    #window2.show()
